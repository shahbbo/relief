...
class changepassworddetails extends StatelessWidget {
  ...
  final TextEditingController confirmPasswordElderController = TextEditingController();
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<RegisterCubit, RegisterState>(
      listener: (context, state) {
        if (state is PatientChangePasswordSuccessState) {
      ...
      builder: (context, state) {
        ...
        return ModalProgressHUD(
          inAsyncCall: state is PatientChangePasswordLoadingState,
          child: Scaffold(
            appBar: AppBar(
              title: const Text(
                'Change Password',
